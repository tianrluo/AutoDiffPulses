function [pulse_o, optInfos] = parctanAD(target, cube, pulse_i, varargin)
...
% - nB (1,), dflt 100, #cycles for parameterizing slew-rate waveforms
% - isHead [T/f], put the uneven param group at the head or tail
% - err_meth str:
...
% - fName dflt 'parctanAD', name of the temporary files.
